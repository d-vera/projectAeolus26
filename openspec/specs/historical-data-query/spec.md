# historical-data-query Specification

## Purpose
REST API endpoints for querying aggregated historical air quality data with predefined time ranges and custom date ranges, including automatic time-bucket-based averaging.

# air-quality-stoplight Specification

## Purpose
Provide a real-time air quality stoplight indicator evaluating telemetry parameters against WHO guidelines across 4 severity levels (Green, Yellow, Orange, Red) with a worst-severity-wins priority system and physiological health impact alerts.

# current-reading-query Specification

## Purpose
REST API endpoint for retrieving the latest air quality reading per device, providing real-time visibility into current conditions.

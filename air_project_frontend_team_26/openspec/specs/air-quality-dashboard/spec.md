...
### Requirement: Sensor map integration on air quality dashboard
The system SHALL display an interactive map section or toggle on the air quality dashboard showing deployed sensor locations and live operational statuses.
